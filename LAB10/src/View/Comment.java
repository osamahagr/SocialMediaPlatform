...
public class Comment extends JPanel {
	...
	public Comment(Model.Comment c) {
		...
		JLabel author = new JLabel(c.getUser().getUserName(), 20, GUIConstants.post,Font.BOLD);	
		...
		bottom.add(new JLabel(c.getDateTimeToString(), 15, GUIConstants.post, Font.PLAIN),
				BorderLayout.EAST);
		add(bottom);
